...
public class TestMsgLogin {
	...
	public void test1() { ///Success
		Message msg = new MsgAccountInfo("201492275" , "3511") ;
	...
	@Test
	public void test2() { ///
		Message msg = new MsgAccountInfo("201492275" , "1111") ;
		RspSingleRow rsp = (RspSingleRow) msg.sendAndReturn() ;
		assertEquals(rsp.getState() , "WrongPassword") ;
	}
	@Test
	public void test3() { ///
		Message msg = new MsgAccountInfo("201492276" , "3511") ;
		RspSingleRow rsp = (RspSingleRow) msg.sendAndReturn() ;
		assertEquals(rsp.getState() , "WrongPassword") ;
	}
	
	public void test4() { ///
		Message msg = new MsgAccountInfo("201492275" , null) ;
		RspSingleRow rsp = (RspSingleRow) msg.sendAndReturn() ;
		assertEquals(rsp.getState() , "success") ;
	}
}
